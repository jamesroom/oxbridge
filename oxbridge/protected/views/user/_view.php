...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('professional')); ?>:</b>
	<?php echo CHtml::encode($data->professional); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('qualificaiotn')); ?>:</b>
	<?php echo CHtml::encode($data->qualificaiotn); ?>
	<br />
